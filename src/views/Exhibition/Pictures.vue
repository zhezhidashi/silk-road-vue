		...
		<div class="ListAndMainImageContainer Card">
			...
			<div style="position: relative; width: 65vw; height: 40vw">
				...
				<img
					...
					:src="ShiftRightSrc"
				/>
				<viewer class="MainImageContainer" :images="ImgList">
					<img
						class="MainImage"
...
export default {
	...
	methods: {
        ...
        // 左右按钮切换图片
        ImageShift(d){
            this.PictureID = ((parseInt(this.PictureID) + d + this.PictureTotal) % this.PictureTotal).toString();
